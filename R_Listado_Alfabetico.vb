Public Class R_Listado_Alfabetico
    ...
    Public Sub valores(ByVal ca As Integer, ByVal mo As String, ByVal ma As String, ByVal lv As Boolean, ByVal ov As Boolean, ByVal leyen As String, ByVal obs As String)
        cant = ca
        modelo = mo
        marca = ma
        Lenyenda_Visible = lv
    ...
    Private Sub R_Listado_Alfabetico_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.sp_consulta_Listado_AlfabeticoTableAdapter.Fill(Me.MELDataSet.sp_consulta_Listado_Alfabetico, cant, marca, modelo)
