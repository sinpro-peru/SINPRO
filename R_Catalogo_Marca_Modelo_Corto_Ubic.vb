Public Class R_Catalogo_Marca_Modelo_Corto_Ubic
    ...
    Public Sub valores_CatalogoModelos_Corto_UBIC(ByVal MarcasModelos As String, ByVal cf As Boolean, ByVal ci As Boolean, ByVal d As Boolean, ByVal mar As Boolean, ByVal mode As Boolean, ByVal Pre As Boolean, ByVal ce As Boolean, ByVal ubi As Boolean, ByVal mp As Boolean, ByVal ex As Integer, ByVal em As Boolean, ByVal ord As String, ByVal gr As String, ByVal com As String, ByVal rg As String, ByVal rc As String, ByVal fubic As String, ByVal lv As Boolean, ByVal ov As Boolean, ByVal leyen As String, ByVal obs As String)
        var = MarcasModelos
        CodFab = cf
        CodInt = ci
        Descripcion = d
        ...
        Leyenda = leyen
    End Sub
    Private Sub R_Catalogo_Marca_Modelo_Corto_Ubic_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.Sp_consultaCatalogoModelos_UbicTableAdapter.Fill(Me.MELDataSet.sp_consultaCatalogoModelos_Ubic, var, exist, order, grupo, compra, resgrupo, rescompra, F_ubic)
